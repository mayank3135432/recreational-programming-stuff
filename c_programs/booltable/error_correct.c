...
int eval2(int values[2]){
    ...
    for(i=0;i<=load;i++){
       ...
       if(postfix[i]=='p'){
       ...
       else if(postfix[i]=='v'||postfix[i]=='+'||postfix[i]=='V'){
        ...
        evalstack[evaltop-1]=IMPLIES(evalstack[evaltop],evalstack[evaltop-1]);
        evaltop--;
       }
       else if(postfix[i]=='='){
...
int eval4(int values[4]){
    ...
    for(i=0;i<=load;i++){
       ...
       else if(postfix[i]=='^'||postfix[i]=='&'||postfix[i]=='*'){//CONJUNCTION
        evalstack[evaltop-1]=AND(evalstack[evaltop],evalstack[evaltop-1]);
        evaltop--;
       }
       else if(postfix[i]=='>'){//CONDITIONAL

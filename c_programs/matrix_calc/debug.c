...
matrix submatrix(matrix A,int x,int y){
    ...
    void checkstat(){//function for debugging
        printf("%d:: i=%d j=%d p=%d q=%d\n",num,i,j,p,q);
        output(B);
        num++;
    }
...
int main(){
    ...
    //output(B);
    matrix A=create(3,3);
    A.arr[0][0]=3;A.arr[0][1]=7;A.arr[0][2]=1;
    A.arr[1][0]=2;A.arr[1][1]=3;A.arr[1][2]=5;
    A.arr[2][0]=7;A.arr[2][1]=5;A.arr[2][2]=4;
